...
| Paper trading started in 2026. | Internal only until audited | `live/logs/performance_tracking_*.csv` | Alpaca paper account | 2026 onward | Do not use as customer proof until reconciled and reviewed. |
