...
For a named account (e.g. `--account client`), use:

```
BROKER_ALPACA_CLIENT_KEY="PKXXXXXXXXXXXXXXXX"
BROKER_ALPACA_CLIENT_SECRET="xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"
```
...
python -m live.rebalance --live --broker alpaca --account client --initialize-lots

# Execute
python -m live.rebalance --live --broker alpaca --account client --execute
```
