...
`drift_absolute(0.05)`. This **reopens** the closed `research/rebalance_frequency/`
verdict (which was transaction-cost-only). See `research/tax_drift_trigger/findings*.md`.
