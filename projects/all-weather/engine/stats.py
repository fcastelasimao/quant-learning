...
def compute_cagr(series: pd.Series, years: float) -> float:
    ...
    """
    return qcs.cagr(series, years=years) * 100
...
def compute_max_drawdown(series: pd.Series) -> float:
    ...
    """
    return qcs.max_drawdown(series) * 100
...
def compute_sharpe(monthly_ret_series: pd.Series,
    ...
    """
    return qcs.sharpe(
        monthly_ret_series.dropna() / 100,
        periods_per_year=config.SHARPE_ANNUALISATION,
        rf_annual=rf_annual,
    )
...
def compute_calmar(cagr: float, max_drawdown: float) -> float:
    ...
    """
    return qcs.calmar(cagr, max_drawdown)
...
def compute_avg_drawdown(series: pd.Series) -> float:
    ...
    """
    return round(qcs.avg_drawdown(series) * 100, 2)
...
def compute_max_drawdown_duration(series: pd.Series) -> int:
    ...
    """
    return qcs.max_drawdown_duration(series)
...
def compute_ulcer_index(series: pd.Series) -> float:
    ...
    """
    return round(qcs.ulcer_index(series, pct=True), 4)
