...
from research.rsi_leverage_overlay.build_mixed_leverage_report import (
    MixedOverlayCandidate,
    default_mixed_candidates,
)


DEFAULT_OUTPUT_ROOT = Path(__file__).resolve().parent / "results" / "mixed_leverage_oos_validation"
DEFAULT_SWEEP_OUTPUT_ROOT = Path(__file__).resolve().parent / "results" / "mixed_leverage_sweep"
DEFAULT_FULL_GRID_OUTPUT_ROOT = Path(__file__).resolve().parent / "results" / "mixed_leverage_full_grid_oos"
