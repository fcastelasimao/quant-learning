...
def _load_root_fmp_downloader():
    # The FMP downloader moved into the shared `quantcore` engine; import the
    # canonical module rather than locating a file by path (robust to where
    # this project lives in the workspace).
    import quantcore.ingest as module
    return module
