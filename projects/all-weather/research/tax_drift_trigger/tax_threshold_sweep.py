"""
research/tax_drift_trigger/tax_threshold_sweep.py (D.18)
========================================================
...
Kill criterion (pre-registered, see findings_threshold_sweep.md)
------------------------------------------------------------------------
...
Artifacts (research/tax_drift_trigger/results/<ts>_<strategy>/)
-------------------------------------------------------
