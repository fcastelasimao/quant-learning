...
cadence), update `failed_strategies/weekly_rebalance/README.md` with the new
...
- Monthly tax granularity (see `docs/research/tax_model.md`).
- `tax_optimal` rows are research counterfactuals; do not cite them as
  Alpaca-achievable (`docs/research/alpaca_lot_selection.md`).
